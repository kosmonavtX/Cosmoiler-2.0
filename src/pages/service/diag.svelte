  ...
  <ListItem accordionItem class={`settings-main__list-item`}>
    ...
    <AccordionContent>
      <Block>
        ...
        <p> - после как погаснет светодиод, выключите питание блока;</p>
        <p> - включите питание блока;</p>
        <p> - после погасания светодиода отпустите кнопку;</p>
        <p> - светодиод должен мигать короткими вспышками;</p>
        <p> - после установления соединения с сервером обновлени светодиод начнет мигать хаотично;</p>
